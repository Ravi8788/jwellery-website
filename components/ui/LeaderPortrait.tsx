...
const SIZE = {
  ...
  md: "h-[5.5rem] w-[5.5rem] xs:h-28 xs:w-28 sm:h-32 sm:w-32 md:h-36 md:w-36 lg:h-40 lg:w-40",
...
const SIZES_ATTR = {
  ...
  md: "(max-width: 475px) 88px, (max-width: 640px) 112px, (max-width: 768px) 128px, 160px",
